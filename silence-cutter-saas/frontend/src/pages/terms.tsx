...
const TermsOfServicePage: NextPage = () => {
  return (
    <Layout title="Terms of Service - Silence Cutter">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <div className="prose max-w-none">
              ...
              <p>
                Welcome to Silence Cutter. These Terms of Service ("Terms")
                govern your use of our website, application, and video
                processing services. By accessing or using our Service, you
              ...
              <ul>
                ...
                <li>
                  ...
                  including videos, that you upload, process, or otherwise
                  submit to the Service.
                </li>
                <li>
                  <strong>Account</strong> refers to a unique account created
              ...
              <p>
                ...
                account. When you register, you must provide accurate and
                complete information. You are responsible for maintaining the
                security of your account and password, and you accept
              ...
              <p>
                ...
                basis. Payment will be charged to your designated payment method
                at the confirmation of your subscription. Subscription fees are
                non-refundable.
              </p>
              ...
              <p>
                ...
                account settings. Upon cancellation, your subscription will
              ...
              <p>
                ...
                the Service, you grant us a non-exclusive, worldwide,
                royalty-free license to use, process, and store your Content for
              ...
              <p>
                ...
                time. We will provide notice of changes to the Terms by posting
                the updated Terms on this page with a new effective date. Your
