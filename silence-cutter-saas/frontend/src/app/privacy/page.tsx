      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-8 rounded-lg shadow-sm">
          ...
          <div className="prose max-w-none">
            ...
            <p>
              Welcome to Silence Cutter ("we," "our," or "us"). We are committed
              to protecting your privacy and handling your data in an open and
            ...
            <p>
              When you upload videos to our service, we collect and process the
              video files and associated metadata. We do not claim ownership of
              your content. You retain all rights to your videos.
            </p>
            ...
            <p>
              ...
              processing, accidental loss, destruction, or damage. Your video
              content is stored in secure cloud storage and processed on secure
              servers.
            </p>
            <p>
            ...
            <p>
              ...
              service, making data-driven business decisions, complying with our
            ...
            <p>
              ...
              other than the country in which you are a resident. These
              countries may have data protection laws that are different from
              those of your country. We implement appropriate safeguards to
              protect your information when it is transferred.
            </p>
